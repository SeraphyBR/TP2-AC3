...
\author{
    ...
    \IEEEauthorblockA{
        ...
        gabriel.ferreira.1116674@sga.pucminas.br
    }
    \and
    ...
    \IEEEauthorblockA{
        \textit{PUC Minas - ICEI} \\
        Belo Horizonte, Brazil\\
        matheus.spindula@sga.pucminas.br
    }
    \and
...
\section{Introdução}
    Este trabalho aborda o tema ``Superescalaridade'' da disciplina ``Arquitetura de Computadores III''.
    Afim de aprofundar mais o tema estudado em sala, foi utilizado como ferramenta o programa
    SuperscalarSIM\cite{b1}. Está presente no trabalho documentações detalhadas dos testes realizados
    no simulador, com o propósito de explorar conceitos de superescalaridade e seus impactos no
...
\section{Análise dos testes}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste1-a}
        \caption{Execução com 1 ALU e total de ciclos: 25}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste1-b}
        \caption{Execução 2 ALU e total de ciclos: 25}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste2-a}
        \caption{Execução 1 ALU e total de ciclos: 25}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste2-b}
        \caption{Execução 2 ALU e total de ciclos: 15}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste3-a}
        \caption{Execução 1 ALU e total de ciclos: 45}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste3-b}
        \caption{Execução 2 ALU e total de ciclos: 45}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste4-a}
        \caption{Execução 1 FP e total de ciclos: 47}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste4-b}
        \caption{Execução 2 FP e total de ciclos: 27}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste5-a}
        \caption{Execução 1 de cada unidade e total de ciclos: 42}
    \end{figure}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.48\textwidth]{teste5-b}
        \caption{Execução 2 de cada unidade e total de ciclos: 35}
    \end{figure}
...
\section{Conclusão}
    Após realizarmos diversos teste no SuperscalarSIM\cite{b1}, foi
    possível compreender que a superescalaridade é um excelente
    modelo de arquitetura, contudo se mostra complexo a forma como
    é executado, devido as diversas etapas e estratégias utilizadas
    para seu aperfeiçoamento. Em outras palavras sua arquitetura
    torna-se mais cara. Na maioria das situações a arquitetura
    se mostra viável, podendo ser notado uma grande melhora em relação
    a outras arquiteturas, porém conforme o código a melhora desejada
    poderá não ser alcançada devido a repetição dos registradores de escrita
